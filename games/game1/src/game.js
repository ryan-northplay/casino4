...
BasicGame.GameLoad.prototype = {
    ...
    create: function() {
		...
		var bar = this.LoaderBar('408', '40', this.game.world.centerX-204, 930, '#000000', '#ff0000');
...
BasicGame.Game.prototype = {
  	create: function(){
		...
		var btn_winl = [];
		var btn_winl_r = [];
		var sym_begin = 211; // X Cord. begin of the first Slot Symbol
		var h1_begin = 126; // X End from Button (left)
		var h2_begin = h1_begin;
		var h1_end = 1710; // X Begin from button (right)
		var h2_end = h1_end;
		var sym_v = 120; // Y Begin of the first Line
		var sym_v_steps = 58; // Y space from buttons
        ...
        settingsbg.ctx.fillStyle = '#922c01';
        settingsbg.ctx.fill();
        ...
        settingsbg2.ctx.fillStyle = '#fe9b00';
